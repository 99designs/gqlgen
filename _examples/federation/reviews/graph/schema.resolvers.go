...
// Code generated by github.com/99designs/gqlgen version v0.17.83-dev
...
func (r *productResolver) ManufacturerID(
	ctx context.Context,
	obj *model.Product,
	federationRequires map[string]any,
) (*string, error) {
