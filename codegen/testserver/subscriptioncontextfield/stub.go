...
type Stub struct {
	...
	SubscriptionResolver struct {
		UserCreated func(ctx context.Context) (<-chan graphql.Event[*User], error)
	}
}
...
func (r *stubSubscription) UserCreated(ctx context.Context) (<-chan graphql.Event[*User], error) {
