		...
		case "findHelloByName":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				...
				func(ctx context.Context) graphql.Marshaler {
					return _Entity_findHelloByName(ctx, ec, field)
				})
		case "findHelloMultiSingleKeysByKey1AndKey2":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, true,
				func(ctx context.Context) graphql.Marshaler {
					return _Entity_findHelloMultiSingleKeysByKey1AndKey2(ctx, ec, field)
				})
		case "findHelloWithErrorsByName":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, true,
				func(ctx context.Context) graphql.Marshaler {
					return _Entity_findHelloWithErrorsByName(ctx, ec, field)
				})
		case "findManyMultiHelloByNames":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, false,
				func(ctx context.Context) graphql.Marshaler {
					return _Entity_findManyMultiHelloByNames(ctx, ec, field)
				})
		case "findManyMultiHelloMultipleRequiresByNames":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, false,
				func(ctx context.Context) graphql.Marshaler {
					return _Entity_findManyMultiHelloMultipleRequiresByNames(ctx, ec, field)
				})
		case "findManyMultiHelloRequiresByNames":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, false,
				func(ctx context.Context) graphql.Marshaler {
					return _Entity_findManyMultiHelloRequiresByNames(ctx, ec, field)
				})
		case "findManyMultiHelloWithErrorByNames":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, false,
				func(ctx context.Context) graphql.Marshaler {
					return _Entity_findManyMultiHelloWithErrorByNames(ctx, ec, field)
				})
		case "findManyMultiPlanetRequiresNestedByNames":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, false,
				func(ctx context.Context) graphql.Marshaler {
					return _Entity_findManyMultiPlanetRequiresNestedByNames(ctx, ec, field)
				})
		case "findPlanetMultipleRequiresByName":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, true,
				func(ctx context.Context) graphql.Marshaler {
					return _Entity_findPlanetMultipleRequiresByName(ctx, ec, field)
				})
		case "findPlanetRequiresByName":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, true,
				func(ctx context.Context) graphql.Marshaler {
					return _Entity_findPlanetRequiresByName(ctx, ec, field)
				})
		case "findPlanetRequiresNestedByName":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, true,
				func(ctx context.Context) graphql.Marshaler {
					return _Entity_findPlanetRequiresNestedByName(ctx, ec, field)
				})
		case "findWorldByHelloNameAndFoo":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, true,
				func(ctx context.Context) graphql.Marshaler {
					return _Entity_findWorldByHelloNameAndFoo(ctx, ec, field)
				})
		case "findWorldNameByName":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, true,
				func(ctx context.Context) graphql.Marshaler {
					return _Entity_findWorldNameByName(ctx, ec, field)
				})
		case "findWorldWithMultipleKeysByHelloNameAndFoo":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, true,
				func(ctx context.Context) graphql.Marshaler {
					return _Entity_findWorldWithMultipleKeysByHelloNameAndFoo(ctx, ec, field)
				})
		case "findWorldWithMultipleKeysByBar":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, true,
				func(ctx context.Context) graphql.Marshaler {
					return _Entity_findWorldWithMultipleKeysByBar(ctx, ec, field)
				})
		default:
	...
	for i, field := range fields {
		...
		case "_entities":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, true,
				func(ctx context.Context) graphql.Marshaler {
					return _Query__entities(ctx, ec, field)
				})
		case "_service":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, true,
				func(ctx context.Context) graphql.Marshaler {
					return _Query__service(ctx, ec, field)
				})
		case "__type":
