...
func (ec *executionContext) unmarshalNEpisode2ᚕgithubᚗcomᚋ99designsᚋgqlgenᚋexampleᚋstarwarsᚋmodelsᚐEpisodeᚄ(ctx context.Context, v interface{}) ([]models.Episode, error) {
	...
	for i := range vSlice {
		...
		res[i], err = ec.unmarshalNEpisode2githubᚗcomᚋ99designsᚋgqlgenᚋexampleᚋstarwarsᚋmodelsᚐEpisode(nctx, vSlice[i])
		if err != nil {
...
func (ec *executionContext) unmarshalNInt2ᚕᚕintᚄ(ctx context.Context, v interface{}) ([][]int, error) {
	...
	for i := range vSlice {
		nctx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithIndex(i))
		res[i], err = ec.unmarshalNInt2ᚕintᚄ(nctx, vSlice[i])
		if err != nil {
			return nil, graphql.WrapErrorWithInputPath(nctx, err)
		}
	}
