...
func (ec *executionContext) _Query_user(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(ctx context.Context) (interface{}, error) {
		var resTmp interface{}
		var err error
		resTmp, err = ec.resolvers.Query().User(ctx, args["id"].(external.ObjectID))
...
func (ec *executionContext) _Query_search(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(ctx context.Context) (interface{}, error) {
		var resTmp interface{}
		var err error
		resTmp, err = ec.resolvers.Query().Search(ctx, args["input"].(*model.SearchArgs))
		if resTmp == nil {
			return resTmp, nil
		}
...
func (ec *executionContext) _User_primitiveResolver(ctx context.Context, field graphql.CollectedField, obj *model.User) graphql.Marshaler {
	...
	resTmp := ec.FieldMiddleware(ctx, obj, func(ctx context.Context) (interface{}, error) {
		var resTmp interface{}
		var err error
		resTmp, err = ec.resolvers.User().PrimitiveResolver(ctx, obj)
		if resTmp == nil {
			return resTmp, nil
		}
...
func (ec *executionContext) _User_customResolver(ctx context.Context, field graphql.CollectedField, obj *model.User) graphql.Marshaler {
	...
	resTmp := ec.FieldMiddleware(ctx, obj, func(ctx context.Context) (interface{}, error) {
		var resTmp interface{}
		var err error
		resTmp, err = ec.resolvers.User().CustomResolver(ctx, obj)
		if resTmp == nil {
			return resTmp, nil
		}
