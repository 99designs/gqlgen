...
func (ec *executionContext) fieldContext_Basic_id(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("Basic", field, false, false, "String")
}
...
func (ec *executionContext) fieldContext_Product_price(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("Product", field, false, false, "Float")
}
		...
		case "findBasicByID":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				...
				func(ctx context.Context) graphql.Marshaler {
					return ec._Entity_findBasicByID(ctx, field)
				})
		case "findPersonByID":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, true,
				func(ctx context.Context) graphql.Marshaler {
					return ec._Entity_findPersonByID(ctx, field)
				})
		case "findProductBySku":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, true,
				func(ctx context.Context) graphql.Marshaler {
					return ec._Entity_findProductBySku(ctx, field)
				})
		default:
			panic("unknown field " + strconv.Quote(field.Name))
		}
	...
	for i, field := range fields {
		...
		case "getPerson":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, false,
				func(ctx context.Context) graphql.Marshaler {
					return ec._Query_getPerson(ctx, field)
				})
		case "getProduct":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, false,
				func(ctx context.Context) graphql.Marshaler {
					return ec._Query_getProduct(ctx, field)
				})
		case "getBasic":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, false,
				func(ctx context.Context) graphql.Marshaler {
					return ec._Query_getBasic(ctx, field)
				})
		case "_entities":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, true,
