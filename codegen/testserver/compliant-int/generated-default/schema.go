...
func (e *executableSchema) Exec(ctx context.Context) graphql.ResponseHandler {
	...
	inputUnmarshalers := func() *graphql.InputUnmarshalerIndex {
		return graphql.NewInputUnmarshalerIndex(
			graphql.NewInputUnmarshaler("Input", ec.unmarshalInputInput),
			graphql.NewInputUnmarshaler("Input64", ec.unmarshalInputInput64),
		)
	}
	first := true
...
func (ec *executionContext) fieldContext_Result_n(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("Result", field, false, false, "Int")
}
...
func (ec *executionContext) fieldContext_Result64_n(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("Result64", field, false, false, "Int64")
}
		...
		case "echoIntToInt":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				...
				func(ctx context.Context) graphql.Marshaler {
					return ec._Query_echoIntToInt(ctx, field)
				})
		case "echoInt64ToInt64":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, true,
				func(ctx context.Context) graphql.Marshaler {
					return ec._Query_echoInt64ToInt64(ctx, field)
				})
		case "echoIntInputToIntObject":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, false,
				func(ctx context.Context) graphql.Marshaler {
					return ec._Query_echoIntInputToIntObject(ctx, field)
				})
		case "echoInt64InputToInt64Object":
			out.ResolveRootConcurrently(innerCtx, ec.OperationContext, i,
				true, false,
				func(ctx context.Context) graphql.Marshaler {
					return ec._Query_echoInt64InputToInt64Object(ctx, field)
				})
		case "__type":
