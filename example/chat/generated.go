...
func (ec *executionContext) _Mutation_post(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(ctx context.Context) (interface{}, error) {
		var resTmp interface{}
		var err error
		resTmp, err = ec.resolvers.Mutation().Post(ctx, args["text"].(string), args["username"].(string), args["roomName"].(string))
		if resTmp == nil {
			return resTmp, nil
		}
...
func (ec *executionContext) _Query_room(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	ec.FieldMiddleware(ctx, nil, func(ctx context.Context) (interface{}, error) {
		var resTmp interface{}
		var err error
		resTmp, err = ec.resolvers.Query().Room(ctx, args["name"].(string))
