...
func (ec *executionContext) _User_created_at(ctx context.Context, field graphql.CollectedField, obj *remote_api.User) (ret graphql.Marshaler) {
...
func (ec *executionContext) unmarshalInputDateFilter(ctx context.Context, obj interface{}) (models.DateFilter, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "op":
			...
			data, err := ec.unmarshalODATE_FILTER_OP2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋintegrationᚋmodelsᚑgoᚐDateFilterOp(ctx, v)
			if err != nil {
				return it, err
			}
			it.Op = data
...
func (ec *executionContext) unmarshalInputListCoercion(ctx context.Context, obj interface{}) (models.ListCoercion, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "enumVal":
			...
			data, err := ec.unmarshalOErrorType2ᚕᚖgithubᚗcomᚋ99designsᚋgqlgenᚋintegrationᚋmodelsᚑgoᚐErrorType(ctx, v)
			if err != nil {
				return it, err
			}
			it.EnumVal = data
