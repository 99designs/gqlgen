...
// The key is index of the entity in the original representations list
// from the router, and the value is the representation of the entity
type GroupedRepresentations map[int]EntityRepresentation
