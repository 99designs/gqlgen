...
type QueryResolver interface {
	...
	OverflowInt32(ctx context.Context, sign Sign) (*int, error)
	EchoInt32In(ctx context.Context, n *int) (int, error)
	EchoInt64In(ctx context.Context, n *int) (int, error)
...
func (ec *executionContext) field_Query_overflowInt32ButReturnInt64_argsSign(
	...
	if tmp, ok := rawArgs["sign"]; ok {
		return ec.unmarshalNSign2githubᚗcomᚋ99designsᚋgqlgenᚋcodegenᚋtestserverᚋcompliantᚑintᚋgenerated_defaultᚐSign(ctx, tmp)
	}
...
func (ec *executionContext) _Query_echoInt32In(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().EchoInt32In(rctx, fc.Args["n"].(*int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalNSign2githubᚗcomᚋ99designsᚋgqlgenᚋcodegenᚋtestserverᚋcompliantᚑintᚋgenerated_defaultᚐSign(ctx context.Context, v interface{}) (Sign, error) {
	var res Sign
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNSign2githubᚗcomᚋ99designsᚋgqlgenᚋcodegenᚋtestserverᚋcompliantᚑintᚋgenerated_defaultᚐSign(ctx context.Context, sel ast.SelectionSet, v Sign) graphql.Marshaler {
	return v
}
