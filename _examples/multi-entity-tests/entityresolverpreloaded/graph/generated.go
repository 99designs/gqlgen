...
func (ec *executionContext) field_Entity_findManyProductByIDs_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "reps",
		func(ctx context.Context, v any) ([]*model.ProductByIDsInput, error) {
			return ec.unmarshalNProductByIDsInput2ᚕᚖentityresolverpreloadedᚋgraphᚋmodelᚐProductByIDsInput(ctx, v)
		})
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) _Entity_findManyProductByIDs(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v []*model.Product) graphql.Marshaler {
			return ec.marshalOProduct2ᚕᚖentityresolverpreloadedᚋgraphᚋmodelᚐProduct(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) fieldContext_Product_category(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("Product", field, false, false, "String")
}
...
func (ec *executionContext) unmarshalNProductByIDsInput2ᚕᚖentityresolverpreloadedᚋgraphᚋmodelᚐProductByIDsInput(ctx context.Context, v any) ([]*model.ProductByIDsInput, error) {
	vSlice := graphql.CoerceList(v)
	var err error
	res := make([]*model.ProductByIDsInput, len(vSlice))
	for i := range vSlice {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithIndex(i))
		res[i], err = ec.unmarshalOProductByIDsInput2ᚖentityresolverpreloadedᚋgraphᚋmodelᚐProductByIDsInput(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) marshalOProduct2ᚕᚖentityresolverpreloadedᚋgraphᚋmodelᚐProduct(ctx context.Context, sel ast.SelectionSet, v []*model.Product) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalOProduct2ᚖentityresolverpreloadedᚋgraphᚋmodelᚐProduct(ctx, sel, v[i])
	})

	return ret
}

func (ec *executionContext) marshalOProduct2ᚖentityresolverpreloadedᚋgraphᚋmodelᚐProduct(ctx context.Context, sel ast.SelectionSet, v *model.Product) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
...
func (ec *executionContext) unmarshalOProductByIDsInput2ᚖentityresolverpreloadedᚋgraphᚋmodelᚐProductByIDsInput(ctx context.Context, v any) (*model.ProductByIDsInput, error) {
	if v == nil {
		return nil, nil
	}
