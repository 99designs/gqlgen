...
func (ec *executionContext) resolveEntity(
	...
	case "PlanetMultipleRequires":
		...
		case "findPlanetMultipleRequiresByName":
			...
			if err != nil {
				return nil, fmt.Errorf(`computing requires for Entity.field "PlanetMultipleRequires.weight": %w`, err)
			}
	...
	case "PlanetRequires":
		...
		case "findPlanetRequiresByName":
			...
			if err != nil {
				return nil, fmt.Errorf(`computing requires for Entity.field "PlanetRequires.size": %w`, err)
			}
			entity.Size = size
	...
	case "PlanetRequiresNested":
		...
		case "findPlanetRequiresNestedByName":
			...
			if err != nil {
				return nil, fmt.Errorf(`computing requires for Entity.field "PlanetRequiresNested.size": %w`, err)
			}
			entity.Size = size
			sizes, err := ec.resolvers.Entity().ComputePlanetRequiresNestedWithWorldsFoo(ctx, entity)
			if err != nil {
				return nil, fmt.Errorf(`computing requires for Entity.field "PlanetRequiresNested.sizes": %w`, err)
			}
			entity.Sizes = sizes
	...
	case "World":
		...
		case "findWorldByHelloNameAndFoo":
			id0, err := ec.unmarshalNString2string(ctx, rep["hello"].(EntityRepresentation)["name"])
			if err != nil {
...
func (ec *executionContext) resolveManyEntities(
	...
	case "MultiPlanetRequiresNested":
		...
		case "findManyMultiPlanetRequiresNestedByNames":
			...
			for i, entity := range entities {
				entity.World.Foo, err = ec.unmarshalNString2string(ctx, reps[i].entity["world"].(EntityRepresentation)["foo"])
				if err != nil {
					return err
				}
				list[reps[i].index] = entity
