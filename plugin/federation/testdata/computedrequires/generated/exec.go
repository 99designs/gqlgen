...
type ComplexityRoot struct {
	Entity struct {
		ComputeManyMultiHelloMultipleRequiresWithKey1AndKey2s func(childComplexity int, reps []*model.MultiHelloMultipleRequiresWithKey1AndKey2sInput) int
		ComputeManyMultiHelloRequiresWithKey1s                func(childComplexity int, reps []*model.MultiHelloRequiresWithKey1sInput) int
		ComputeManyMultiPlanetRequiresNestedWithWorldFoos     func(childComplexity int, reps []*model.MultiPlanetRequiresNestedWithWorldFoosInput) int
		ComputePlanetMultipleRequiresWithDiameterAndDensity   func(childComplexity int, diameter int, density int) int
		ComputePlanetRequiresNestedWithWorldFoo               func(childComplexity int, worldFoo string) int
		ComputePlanetRequiresNestedWithWorldsFoo              func(childComplexity int, worldsFoo string) int
		ComputePlanetRequiresWithDiameter                     func(childComplexity int, diameter int) int
...
type EntityResolver interface {
	...
	ComputeManyMultiHelloMultipleRequiresWithKey1AndKey2s(ctx context.Context, reps []*model.MultiHelloMultipleRequiresWithKey1AndKey2sInput) ([]*model.MultiHelloMultipleRequires, error)
	...
	ComputeManyMultiHelloRequiresWithKey1s(ctx context.Context, reps []*model.MultiHelloRequiresWithKey1sInput) ([]*model.MultiHelloRequires, error)
	...
	ComputeManyMultiPlanetRequiresNestedWithWorldFoos(ctx context.Context, reps []*model.MultiPlanetRequiresNestedWithWorldFoosInput) ([]*model.MultiPlanetRequiresNested, error)
	FindPlanetMultipleRequiresByName(ctx context.Context, name string) (*model.PlanetMultipleRequires, error)
	ComputePlanetMultipleRequiresWithDiameterAndDensity(ctx context.Context, diameter int, density int) (*model.PlanetMultipleRequires, error)
	FindPlanetRequiresByName(ctx context.Context, name string) (*model.PlanetRequires, error)
	ComputePlanetRequiresWithDiameter(ctx context.Context, diameter int) (*model.PlanetRequires, error)
	FindPlanetRequiresNestedByName(ctx context.Context, name string) (*model.PlanetRequiresNested, error)
	ComputePlanetRequiresNestedWithWorldFoo(ctx context.Context, worldFoo string) (*model.PlanetRequiresNested, error)
	ComputePlanetRequiresNestedWithWorldsFoo(ctx context.Context, worldsFoo string) (*model.PlanetRequiresNested, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Entity.computeManyMultiHelloMultipleRequiresWithKey1AndKey2s":
		...
		return e.complexity.Entity.ComputeManyMultiHelloMultipleRequiresWithKey1AndKey2s(childComplexity, args["reps"].([]*model.MultiHelloMultipleRequiresWithKey1AndKey2sInput)), true
	...
	case "Entity.computeManyMultiHelloRequiresWithKey1s":
		...
		return e.complexity.Entity.ComputeManyMultiHelloRequiresWithKey1s(childComplexity, args["reps"].([]*model.MultiHelloRequiresWithKey1sInput)), true
	...
	case "Entity.computeManyMultiPlanetRequiresNestedWithWorldFoos":
		...
		return e.complexity.Entity.ComputeManyMultiPlanetRequiresNestedWithWorldFoos(childComplexity, args["reps"].([]*model.MultiPlanetRequiresNestedWithWorldFoosInput)), true
	...
	case "Entity.computePlanetMultipleRequiresWithDiameterAndDensity":
		...
		return e.complexity.Entity.ComputePlanetMultipleRequiresWithDiameterAndDensity(childComplexity, args["diameter"].(int), args["density"].(int)), true
	...
	case "Entity.computePlanetRequiresNestedWithWorldFoo":
		...
		return e.complexity.Entity.ComputePlanetRequiresNestedWithWorldFoo(childComplexity, args["worldFoo"].(string)), true
	...
	case "Entity.computePlanetRequiresNestedWithWorldsFoo":
		...
		return e.complexity.Entity.ComputePlanetRequiresNestedWithWorldsFoo(childComplexity, args["worldsFoo"].(string)), true
	...
	case "Entity.computePlanetRequiresWithDiameter":
		...
		return e.complexity.Entity.ComputePlanetRequiresWithDiameter(childComplexity, args["diameter"].(int)), true
...
func (e *executableSchema) Exec(ctx context.Context) graphql.ResponseHandler {
	...
	inputUnmarshalMap := graphql.BuildUnmarshalerMap(
		...
		ec.unmarshalInputMultiHelloMultipleRequiresWithKey1AndKey2sInput,
		ec.unmarshalInputMultiHelloRequiresByNamesInput,
		ec.unmarshalInputMultiHelloRequiresWithKey1sInput,
		ec.unmarshalInputMultiHelloWithErrorByNamesInput,
		ec.unmarshalInputMultiPlanetRequiresNestedByNamesInput,
		ec.unmarshalInputMultiPlanetRequiresNestedWithWorldFoosInput,
	)
	first := true
...
input MultiHelloMultipleRequiresWithKey1AndKey2sInput {
	Key1: String!
	Key2: String!
}
...
input MultiHelloRequiresWithKey1sInput {
	Key1: String!
}
...
input MultiPlanetRequiresNestedWithWorldFoosInput {
	WorldFoo: String!
}
...
type Entity {
	...
	computeManyMultiHelloMultipleRequiresWithKey1AndKey2s(reps: [MultiHelloMultipleRequiresWithKey1AndKey2sInput]!): [MultiHelloMultipleRequires]
	findManyMultiHelloRequiresByNames(reps: [MultiHelloRequiresByNamesInput]!): [MultiHelloRequires]
	computeManyMultiHelloRequiresWithKey1s(reps: [MultiHelloRequiresWithKey1sInput]!): [MultiHelloRequires]
	...
	computeManyMultiPlanetRequiresNestedWithWorldFoos(reps: [MultiPlanetRequiresNestedWithWorldFoosInput]!): [MultiPlanetRequiresNested]
	findPlanetMultipleRequiresByName(name: String!,): PlanetMultipleRequires!
	computePlanetMultipleRequiresWithDiameterAndDensity(diameter: Int!,density: Int!,): PlanetMultipleRequires!
	findPlanetRequiresByName(name: String!,): PlanetRequires!
	computePlanetRequiresWithDiameter(diameter: Int!,): PlanetRequires!
	findPlanetRequiresNestedByName(name: String!,): PlanetRequiresNested!
	computePlanetRequiresNestedWithWorldFoo(worldFoo: String!,): PlanetRequiresNested!
	computePlanetRequiresNestedWithWorldsFoo(worldsFoo: String!,): PlanetRequiresNested!
...
func (ec *executionContext) field_Entity_computeManyMultiHelloMultipleRequiresWithKey1AndKey2s_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 []*model.MultiHelloMultipleRequiresWithKey1AndKey2sInput
	if tmp, ok := rawArgs["reps"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("reps"))
		arg0, err = ec.unmarshalNMultiHelloMultipleRequiresWithKey1AndKey2sInput2ᚕᚖgithubᚗcomᚋ99designsᚋgqlgenᚋpluginᚋfederationᚋtestdataᚋcomputedrequiresᚋgeneratedᚋmodelsᚐMultiHelloMultipleRequiresWithKey1AndKey2sInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Entity_computeManyMultiHelloRequiresWithKey1s_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 []*model.MultiHelloRequiresWithKey1sInput
	if tmp, ok := rawArgs["reps"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("reps"))
		arg0, err = ec.unmarshalNMultiHelloRequiresWithKey1sInput2ᚕᚖgithubᚗcomᚋ99designsᚋgqlgenᚋpluginᚋfederationᚋtestdataᚋcomputedrequiresᚋgeneratedᚋmodelsᚐMultiHelloRequiresWithKey1sInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Entity_computeManyMultiPlanetRequiresNestedWithWorldFoos_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 []*model.MultiPlanetRequiresNestedWithWorldFoosInput
	if tmp, ok := rawArgs["reps"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("reps"))
		arg0, err = ec.unmarshalNMultiPlanetRequiresNestedWithWorldFoosInput2ᚕᚖgithubᚗcomᚋ99designsᚋgqlgenᚋpluginᚋfederationᚋtestdataᚋcomputedrequiresᚋgeneratedᚋmodelsᚐMultiPlanetRequiresNestedWithWorldFoosInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Entity_computePlanetRequiresNestedWithWorldsFoo_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["worldsFoo"]; ok {
...
func (ec *executionContext) _Entity_computeManyMultiHelloMultipleRequiresWithKey1AndKey2s(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		directive0 := func(rctx context.Context) (interface{}, error) {
			ctx = rctx // use context from middleware stack in children
			return ec.resolvers.Entity().ComputeManyMultiHelloMultipleRequiresWithKey1AndKey2s(rctx, fc.Args["reps"].([]*model.MultiHelloMultipleRequiresWithKey1AndKey2sInput))
		}
		directive1 := func(ctx context.Context) (interface{}, error) {
			multi, err := ec.unmarshalOBoolean2ᚖbool(ctx, true)
			if err != nil {
...
func (ec *executionContext) _Entity_computeManyMultiHelloRequiresWithKey1s(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		directive0 := func(rctx context.Context) (interface{}, error) {
			ctx = rctx // use context from middleware stack in children
			return ec.resolvers.Entity().ComputeManyMultiHelloRequiresWithKey1s(rctx, fc.Args["reps"].([]*model.MultiHelloRequiresWithKey1sInput))
		}
		directive1 := func(ctx context.Context) (interface{}, error) {
			multi, err := ec.unmarshalOBoolean2ᚖbool(ctx, true)
			if err != nil {
...
func (ec *executionContext) _Entity_computeManyMultiPlanetRequiresNestedWithWorldFoos(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		directive0 := func(rctx context.Context) (interface{}, error) {
			ctx = rctx // use context from middleware stack in children
			return ec.resolvers.Entity().ComputeManyMultiPlanetRequiresNestedWithWorldFoos(rctx, fc.Args["reps"].([]*model.MultiPlanetRequiresNestedWithWorldFoosInput))
		}
		directive1 := func(ctx context.Context) (interface{}, error) {
			multi, err := ec.unmarshalOBoolean2ᚖbool(ctx, true)
			if err != nil {
...
func (ec *executionContext) _Entity_computePlanetMultipleRequiresWithDiameterAndDensity(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Entity().ComputePlanetMultipleRequiresWithDiameterAndDensity(rctx, fc.Args["diameter"].(int), fc.Args["density"].(int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Entity_computePlanetRequiresWithDiameter(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Entity().ComputePlanetRequiresWithDiameter(rctx, fc.Args["diameter"].(int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Entity_computePlanetRequiresNestedWithWorldFoo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Entity().ComputePlanetRequiresNestedWithWorldFoo(rctx, fc.Args["worldFoo"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Entity_computePlanetRequiresNestedWithWorldsFoo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Entity().ComputePlanetRequiresNestedWithWorldsFoo(rctx, fc.Args["worldsFoo"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputMultiHelloMultipleRequiresWithKey1AndKey2sInput(ctx context.Context, obj interface{}) (model.MultiHelloMultipleRequiresWithKey1AndKey2sInput, error) {
	var it model.MultiHelloMultipleRequiresWithKey1AndKey2sInput
	asMap := map[string]interface{}{}
	for k, v := range obj.(map[string]interface{}) {
		asMap[k] = v
	}
...
func (ec *executionContext) unmarshalInputMultiHelloRequiresWithKey1sInput(ctx context.Context, obj interface{}) (model.MultiHelloRequiresWithKey1sInput, error) {
	var it model.MultiHelloRequiresWithKey1sInput
	asMap := map[string]interface{}{}
	for k, v := range obj.(map[string]interface{}) {
		asMap[k] = v
	}
...
func (ec *executionContext) unmarshalInputMultiPlanetRequiresNestedWithWorldFoosInput(ctx context.Context, obj interface{}) (model.MultiPlanetRequiresNestedWithWorldFoosInput, error) {
	var it model.MultiPlanetRequiresNestedWithWorldFoosInput
	asMap := map[string]interface{}{}
	for k, v := range obj.(map[string]interface{}) {
		asMap[k] = v
	}
...
func (ec *executionContext) unmarshalNMultiHelloMultipleRequiresWithKey1AndKey2sInput2ᚕᚖgithubᚗcomᚋ99designsᚋgqlgenᚋpluginᚋfederationᚋtestdataᚋcomputedrequiresᚋgeneratedᚋmodelsᚐMultiHelloMultipleRequiresWithKey1AndKey2sInput(ctx context.Context, v interface{}) ([]*model.MultiHelloMultipleRequiresWithKey1AndKey2sInput, error) {
	var vSlice []interface{}
	if v != nil {
		vSlice = graphql.CoerceList(v)
	}
	var err error
	res := make([]*model.MultiHelloMultipleRequiresWithKey1AndKey2sInput, len(vSlice))
	for i := range vSlice {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithIndex(i))
		res[i], err = ec.unmarshalOMultiHelloMultipleRequiresWithKey1AndKey2sInput2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋpluginᚋfederationᚋtestdataᚋcomputedrequiresᚋgeneratedᚋmodelsᚐMultiHelloMultipleRequiresWithKey1AndKey2sInput(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalNMultiHelloRequiresWithKey1sInput2ᚕᚖgithubᚗcomᚋ99designsᚋgqlgenᚋpluginᚋfederationᚋtestdataᚋcomputedrequiresᚋgeneratedᚋmodelsᚐMultiHelloRequiresWithKey1sInput(ctx context.Context, v interface{}) ([]*model.MultiHelloRequiresWithKey1sInput, error) {
	var vSlice []interface{}
	if v != nil {
		vSlice = graphql.CoerceList(v)
	}
	var err error
	res := make([]*model.MultiHelloRequiresWithKey1sInput, len(vSlice))
	for i := range vSlice {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithIndex(i))
		res[i], err = ec.unmarshalOMultiHelloRequiresWithKey1sInput2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋpluginᚋfederationᚋtestdataᚋcomputedrequiresᚋgeneratedᚋmodelsᚐMultiHelloRequiresWithKey1sInput(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalNMultiPlanetRequiresNestedWithWorldFoosInput2ᚕᚖgithubᚗcomᚋ99designsᚋgqlgenᚋpluginᚋfederationᚋtestdataᚋcomputedrequiresᚋgeneratedᚋmodelsᚐMultiPlanetRequiresNestedWithWorldFoosInput(ctx context.Context, v interface{}) ([]*model.MultiPlanetRequiresNestedWithWorldFoosInput, error) {
	var vSlice []interface{}
	if v != nil {
		vSlice = graphql.CoerceList(v)
	}
	var err error
	res := make([]*model.MultiPlanetRequiresNestedWithWorldFoosInput, len(vSlice))
	for i := range vSlice {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithIndex(i))
		res[i], err = ec.unmarshalOMultiPlanetRequiresNestedWithWorldFoosInput2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋpluginᚋfederationᚋtestdataᚋcomputedrequiresᚋgeneratedᚋmodelsᚐMultiPlanetRequiresNestedWithWorldFoosInput(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalOMultiHelloMultipleRequiresWithKey1AndKey2sInput2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋpluginᚋfederationᚋtestdataᚋcomputedrequiresᚋgeneratedᚋmodelsᚐMultiHelloMultipleRequiresWithKey1AndKey2sInput(ctx context.Context, v interface{}) (*model.MultiHelloMultipleRequiresWithKey1AndKey2sInput, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalInputMultiHelloMultipleRequiresWithKey1AndKey2sInput(ctx, v)
	return &res, graphql.ErrorOnPath(ctx, err)
}
...
func (ec *executionContext) unmarshalOMultiHelloRequiresWithKey1sInput2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋpluginᚋfederationᚋtestdataᚋcomputedrequiresᚋgeneratedᚋmodelsᚐMultiHelloRequiresWithKey1sInput(ctx context.Context, v interface{}) (*model.MultiHelloRequiresWithKey1sInput, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalInputMultiHelloRequiresWithKey1sInput(ctx, v)
	return &res, graphql.ErrorOnPath(ctx, err)
}
...
func (ec *executionContext) unmarshalOMultiPlanetRequiresNestedWithWorldFoosInput2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋpluginᚋfederationᚋtestdataᚋcomputedrequiresᚋgeneratedᚋmodelsᚐMultiPlanetRequiresNestedWithWorldFoosInput(ctx context.Context, v interface{}) (*model.MultiPlanetRequiresNestedWithWorldFoosInput, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalInputMultiPlanetRequiresNestedWithWorldFoosInput(ctx, v)
	return &res, graphql.ErrorOnPath(ctx, err)
}
