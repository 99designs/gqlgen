...
[gqlgen](https://github.com/john-markham/gqlgen) is a Go library for building GraphQL servers without any fuss.<br/>
...
2. Add `github.com/john-markham/gqlgen` to your [project's tools.go](https://go.dev/wiki/Modules#how-can-i-track-tool-dependencies-for-a-module)

       printf '//go:build tools\npackage tools\nimport (_ "github.com/john-markham/gqlgen"\n _ "github.com/john-markham/gqlgen/graphql/introspection")' | gofmt > tools.go
...
More help to get started:
 ...
 - [Real-world examples](https://github.com/john-markham/gqlgen/tree/master/_examples) show how to create GraphQL applications
 - [Reference docs](https://pkg.go.dev/github.com/john-markham/gqlgen) for the APIs

## Reporting Issues

If you think you've found a bug, or something isn't behaving the way you think it should, please raise an [issue](https://github.com/john-markham/gqlgen/issues) on GitHub.

## Contributing

We welcome contributions, Read our [Contribution Guidelines](https://github.com/john-markham/gqlgen/blob/master/CONTRIBUTING.md) to learn more about contributing to **gqlgen**
...
models:
  ID: # The GraphQL type ID is backed by
    model:
      - github.com/john-markham/gqlgen/graphql.IntID # a go integer
      - github.com/john-markham/gqlgen/graphql.ID # or a go string
      - github.com/john-markham/gqlgen/graphql.UintID # or a go uint
```
