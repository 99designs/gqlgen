...
func (ec *executionContext) field_Query_search_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "filters",
		func(ctx context.Context, v any) (SearchFilters, error) {
			return ec.unmarshalNSearchFilters2githubᚗcomᚋ99designsᚋgqlgenᚋcodegenᚋtestserverᚋomittypedinputunmarshalersᚐSearchFilters(ctx, v)
		})
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) unmarshalNSearchFilters2githubᚗcomᚋ99designsᚋgqlgenᚋcodegenᚋtestserverᚋomittypedinputunmarshalersᚐSearchFilters(ctx context.Context, v any) (SearchFilters, error) {
