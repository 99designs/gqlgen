...
func (ec *executionContext) _Element(ctx context.Context, sel []query.Selection, obj *Element) graphql.Marshaler {
	...
	fields := graphql.CollectFields(reqctx, sel, elementImplementors, ec.Variables)
...
func (ec *executionContext) _User(ctx context.Context, sel []query.Selection, obj *remote_api.User) graphql.Marshaler {
	reqctx := graphql.GetRequestContext(ctx)
	fields := graphql.CollectFields(reqctx, sel, userImplementors, ec.Variables)
...
func (ec *executionContext) _Viewer(ctx context.Context, sel []query.Selection, obj *Viewer) graphql.Marshaler {
	reqctx := graphql.GetRequestContext(ctx)
	fields := graphql.CollectFields(reqctx, sel, viewerImplementors, ec.Variables)
