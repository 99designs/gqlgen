...
func (ec *executionContext) field_Query_torture1d_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["customerIds"]; ok {
		arg0, err = ec.unmarshalOInt2ᚕint(tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Query_torture2d_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	var arg0 [][]int
	if tmp, ok := rawArgs["customerIds"]; ok {
		arg0, err = ec.unmarshalOInt2ᚕᚕint(tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalNTime2timeᚐTime(v interface{}) (time.Time, error) {
...
func (ec *executionContext) unmarshalOInt2ᚕint(v interface{}) ([]int, error) {
	var vSlice []interface{}
	if v != nil {
		if tmp1, ok := v.([]interface{}); ok {
			vSlice = tmp1
...
func (ec *executionContext) unmarshalOInt2ᚕᚕint(v interface{}) ([][]int, error) {
	var vSlice []interface{}
	if v != nil {
		if tmp1, ok := v.([]interface{}); ok {
			vSlice = tmp1
	...
	res := make([][]int, len(vSlice))
	for i := range vSlice {
		res[i], err = ec.unmarshalOInt2ᚕint(vSlice[i])
		if err != nil {
			return nil, err
		}
	}
