...
func (ec *executionContext) field_Query_torture1d_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["customerIds"]; ok {
		childCtx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithField("customerIds"))
		arg0, err = ec.unmarshalOInt2ᚕintᚄ(childCtx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Query_torture2d_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["customerIds"]; ok {
		childCtx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithField("customerIds"))
		arg0, err = ec.unmarshalOInt2ᚕᚕint(childCtx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalOInt2ᚕintᚄ(ctx context.Context, v interface{}) ([]int, error) {
	...
	for i := range vSlice {
		nctx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithIndex(i))
		res[i], err = ec.unmarshalNInt2int(nctx, vSlice[i])
		if err != nil {
			return nil, graphql.WrapErrorWithInputPath(nctx, err)
		}
	}
...
func (ec *executionContext) unmarshalOInt2ᚕᚕint(ctx context.Context, v interface{}) ([][]int, error) {
	...
	for i := range vSlice {
		nctx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithIndex(i))
		res[i], err = ec.unmarshalOInt2ᚕintᚄ(nctx, vSlice[i])
		if err != nil {
			return nil, graphql.WrapErrorWithInputPath(nctx, err)
		}
	}
